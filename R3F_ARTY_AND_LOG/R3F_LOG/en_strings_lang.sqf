...
STR_R3F_LOG_action_charger_selection_pas_assez_de_place = "There is not enough space in this vehicle.";
...
STR_R3F_LOG_action_remorquer_selection_trop_loin = "The object ""%1"" cannot be towed right now.";
