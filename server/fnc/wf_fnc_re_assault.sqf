Private ["_attackLoc","_spawnLoc","_lightarmor","_air","_heavyarmor"];
...
["wf_hqchat", ["We have reports from aircraft that the enemy are preparing another assault on the FOB. Get back to the FOB ASAP to help defend the position!"]] call CBA_fnc_globalEvent;
