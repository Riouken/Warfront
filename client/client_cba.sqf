...
["wf_transport_mission", 
	{
		...
		"wf_transport_marker" setMarkerTypeLocal "Pickup";
...
["wf_airsupt_mission", 
	{
		...
		_newTask setSimpleTaskDescription [_caller + " Is requesting Air Support at this location - " + _gridPos,"Team Transport",""];
		_newTask setSimpleTaskDestination _loc;
		_newTask setTaskState "Assigned";
		player setCurrentTask _newTask;
		...
		"wf_airsupt_marker" setMarkerTypeLocal "FireMission";
